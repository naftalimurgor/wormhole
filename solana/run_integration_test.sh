...
ARTIFACTS=$ROOT/artifacts-devnet
ACCOUNTS=$ROOT/tests/accounts
TEST=$ROOT/.test
...
solana-test-validator --reset \
  ...
  --bpf-program metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s $ROOT/modules/token_bridge/token-metadata/spl_token_metadata.so \
