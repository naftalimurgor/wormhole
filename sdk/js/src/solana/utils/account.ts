 ...
 */
export function newAccountMeta(pubkey: PublicKeyInitData, isSigner: boolean): AccountMeta {
  return {
 ...
 */
export function newReadOnlyAccountMeta(pubkey: PublicKeyInitData, isSigner: boolean): AccountMeta {
  return {
    pubkey: new PublicKey(pubkey),
    isWritable: false,
    isSigner,
